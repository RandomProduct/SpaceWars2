...
struct  X509KeyUsageFlags_t1873715468 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(X509KeyUsageFlags_t1873715468, ___value___1)); }
