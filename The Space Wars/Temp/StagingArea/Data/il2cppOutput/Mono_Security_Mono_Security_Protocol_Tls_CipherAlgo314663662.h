...
struct  CipherAlgorithmType_t314663662 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(CipherAlgorithmType_t314663662, ___value___1)); }
