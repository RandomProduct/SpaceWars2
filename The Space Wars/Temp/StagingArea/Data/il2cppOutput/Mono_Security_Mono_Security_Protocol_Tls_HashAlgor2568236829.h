...
struct  HashAlgorithmType_t2568236829 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(HashAlgorithmType_t2568236829, ___value___1)); }
