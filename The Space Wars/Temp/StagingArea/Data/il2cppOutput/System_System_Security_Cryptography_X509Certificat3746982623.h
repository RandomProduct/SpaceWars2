...
struct  X509ChainStatusFlags_t3746982623 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(X509ChainStatusFlags_t3746982623, ___value___1)); }
