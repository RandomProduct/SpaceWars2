...
struct  ExtenderType_t1447154559 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ExtenderType_t1447154559, ___value___1)); }
