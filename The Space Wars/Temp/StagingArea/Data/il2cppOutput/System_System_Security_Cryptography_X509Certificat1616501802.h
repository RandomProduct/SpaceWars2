...
struct  X509ChainElement_t1616501802  : public Il2CppObject
{
public:
	...
	X509Certificate2_t3653580638 * ___certificate_0;
	...
	X509ChainStatusU5BU5D_t785887285* ___status_1;
...
public:
	inline static int32_t get_offset_of_certificate_0() { return static_cast<int32_t>(offsetof(X509ChainElement_t1616501802, ___certificate_0)); }
	inline X509Certificate2_t3653580638 * get_certificate_0() const { return ___certificate_0; }
	inline X509Certificate2_t3653580638 ** get_address_of_certificate_0() { return &___certificate_0; }
	inline void set_certificate_0(X509Certificate2_t3653580638 * value)
	{
		___certificate_0 = value;
		Il2CppCodeGenWriteBarrier(&___certificate_0, value);
	}

	inline static int32_t get_offset_of_status_1() { return static_cast<int32_t>(offsetof(X509ChainElement_t1616501802, ___status_1)); }
	inline X509ChainStatusU5BU5D_t785887285* get_status_1() const { return ___status_1; }
	inline X509ChainStatusU5BU5D_t785887285** get_address_of_status_1() { return &___status_1; }
	inline void set_status_1(X509ChainStatusU5BU5D_t785887285* value)
	{
		___status_1 = value;
		Il2CppCodeGenWriteBarrier(&___status_1, value);
	}

	inline static int32_t get_offset_of_info_2() { return static_cast<int32_t>(offsetof(X509ChainElement_t1616501802, ___info_2)); }
	...
	inline static int32_t get_offset_of_compressed_status_flags_3() { return static_cast<int32_t>(offsetof(X509ChainElement_t1616501802, ___compressed_status_flags_3)); }
