...
struct  SecurityProtocolType_t4187179796 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(SecurityProtocolType_t4187179796, ___value___1)); }
