...
struct  EnumeratorMode_t2450578873 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(EnumeratorMode_t2450578873, ___value___1)); }
