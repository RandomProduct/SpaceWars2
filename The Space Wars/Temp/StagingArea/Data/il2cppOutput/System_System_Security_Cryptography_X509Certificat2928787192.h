...
struct  X509FindType_t2928787192 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(X509FindType_t2928787192, ___value___1)); }
