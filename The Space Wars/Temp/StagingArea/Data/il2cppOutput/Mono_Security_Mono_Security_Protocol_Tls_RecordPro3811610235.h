...
struct  ReceiveRecordAsyncResult_t3811610235  : public Il2CppObject
{
public:
	...
	ByteU5BU5D_t3835026402* ____initialBuffer_8;

public:
	inline static int32_t get_offset_of_locker_0() { return static_cast<int32_t>(offsetof(ReceiveRecordAsyncResult_t3811610235, ___locker_0)); }
	...
	inline static int32_t get_offset_of__userCallback_1() { return static_cast<int32_t>(offsetof(ReceiveRecordAsyncResult_t3811610235, ____userCallback_1)); }
	...
	inline static int32_t get_offset_of__userState_2() { return static_cast<int32_t>(offsetof(ReceiveRecordAsyncResult_t3811610235, ____userState_2)); }
	...
	inline static int32_t get_offset_of__asyncException_3() { return static_cast<int32_t>(offsetof(ReceiveRecordAsyncResult_t3811610235, ____asyncException_3)); }
	...
	inline static int32_t get_offset_of_handle_4() { return static_cast<int32_t>(offsetof(ReceiveRecordAsyncResult_t3811610235, ___handle_4)); }
	...
	inline static int32_t get_offset_of__resultingBuffer_5() { return static_cast<int32_t>(offsetof(ReceiveRecordAsyncResult_t3811610235, ____resultingBuffer_5)); }
	inline ByteU5BU5D_t3835026402* get__resultingBuffer_5() const { return ____resultingBuffer_5; }
	inline ByteU5BU5D_t3835026402** get_address_of__resultingBuffer_5() { return &____resultingBuffer_5; }
	inline void set__resultingBuffer_5(ByteU5BU5D_t3835026402* value)
	{
		____resultingBuffer_5 = value;
		Il2CppCodeGenWriteBarrier(&____resultingBuffer_5, value);
	}

	inline static int32_t get_offset_of__record_6() { return static_cast<int32_t>(offsetof(ReceiveRecordAsyncResult_t3811610235, ____record_6)); }
	inline Stream_t2768948945 * get__record_6() const { return ____record_6; }
	inline Stream_t2768948945 ** get_address_of__record_6() { return &____record_6; }
	inline void set__record_6(Stream_t2768948945 * value)
	{
		____record_6 = value;
		Il2CppCodeGenWriteBarrier(&____record_6, value);
	}

	inline static int32_t get_offset_of_completed_7() { return static_cast<int32_t>(offsetof(ReceiveRecordAsyncResult_t3811610235, ___completed_7)); }
	...
	inline static int32_t get_offset_of__initialBuffer_8() { return static_cast<int32_t>(offsetof(ReceiveRecordAsyncResult_t3811610235, ____initialBuffer_8)); }
	inline ByteU5BU5D_t3835026402* get__initialBuffer_8() const { return ____initialBuffer_8; }
	inline ByteU5BU5D_t3835026402** get_address_of__initialBuffer_8() { return &____initialBuffer_8; }
	inline void set__initialBuffer_8(ByteU5BU5D_t3835026402* value)
	{
